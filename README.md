# d-someone Tech Guides

> Focused, in-depth technical guides for engineers — covering DevOps, data engineering, and the tools and concepts that connect them.
...
## Found a mistake? Want to suggest a topic?

This is the most valuable thing you can do for the project.

- **Spotted an error or something out of date?** [Open a correction issue.](../../issues/new?template=correction.md)
- **Want a guide on a topic that isn't here?** [Suggest one.](../../issues/new?template=guide-request.md)
- **Have a question that isn't covered?** [Ask in discussions.](../../discussions)

---

## Maintainer

Maintained by **Avishni** · [LinkedIn](https://www.linkedin.com/in/avishni/)

If a guide saved you time, a ⭐ on the repo is the easiest way to say thanks (and helps others find it).
